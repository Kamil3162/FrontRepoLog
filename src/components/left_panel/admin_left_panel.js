...
import {LeftPanel, LeftPanelItem, LogoPanelItem, MenuItems, PanelItemText} from "../../assets/styles/home_styled";
...
import navigation_bar from "../../assets/icons/naviagation_navbar.png";
...
function AdminPanel({navigate}){
    ...
    return (
        <LeftPanel>
            ...
            <LeftPanelItem onClick={toggleMenu}>
                <LogoPanelItem src={navigation_bar}/>
            </LeftPanelItem>
            <MenuItems isVisible={isMenuVisible}>
                {
                    isMenuVisible && (
                        <>
